  ...
  return (
    <div className="min-h-screen bg-[var(--canvas)] px-4 py-5 lg:px-8 lg:py-8">
      <div className="mx-auto grid min-h-[calc(100vh-2.5rem)] w-full max-w-[1300px] overflow-hidden rounded-[2rem] border border-[color:var(--ghost)] bg-white shadow-[0_22px_60px_rgba(13,24,41,0.12)] lg:grid-cols-[1.05fr_0.95fr]">
        ...
        <section className="relative flex w-full items-center justify-center bg-[var(--soft-100)]/60 px-5 py-8 sm:px-8 md:justify-end lg:px-10">
          ...
          <div className="relative z-10 w-full max-w-[560px] rounded-[2rem] border border-[color:var(--ghost)] bg-white/95 p-6 shadow-[0_20px_55px_rgba(13,24,41,0.12)] sm:p-8 md:ml-auto">
